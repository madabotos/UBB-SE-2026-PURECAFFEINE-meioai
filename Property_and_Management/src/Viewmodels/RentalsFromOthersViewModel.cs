...
namespace Property_and_Management.src.Viewmodels
{
    public class RentalsFromOthersViewModel : INotifyPropertyChanged
    {
        ...
        // [REQ-REN-01] As an Owner, I must be able to see all confirmed rentals of my games,
        // including the renter's name, game, and rental period.
        ...
        // [REQ-REN-04] As an Owner, I should see rentals in descending order by start date.
