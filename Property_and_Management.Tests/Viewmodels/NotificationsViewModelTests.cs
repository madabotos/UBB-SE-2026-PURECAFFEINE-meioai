...
namespace Property_and_Management.Tests.Viewmodels
{
    ...
    public class NotificationsViewModelTests
    {
        ...
        public void Setup()
        {
            ...
            notificationService
                .Setup(s => s.Subscribe(It.IsAny<IObserver<NotificationDTO>>()))
        ...
        {
            notificationService
                .Setup(s => s.GetNotificationsForUser(1))
        ...
        public void DeleteNotificationByIdentifier_CallsServiceDelete()
        {
            ...
            notificationService.Verify(s => s.DeleteNotificationByIdentifier(7), Times.Once);
        }
    }
}
